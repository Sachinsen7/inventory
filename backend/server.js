...
const allowedOrigins = (process.env.ALLOWED_ORIGINS || "https://localhost:3000,https://localhost:5000,https://0.0.0.0:3000,https://0.0.0.0:5000,https://inventory.works,https://www.inventory.works")
  .split(",")
  .map((o) => o.trim());
